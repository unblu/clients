...
/**
 * Gets or Sets ELayerStopReasonOperatorType
 */
public enum ELayerStopReasonOperatorType {
	...
	ELayerStopReasonOperatorType(String value) {
		this.value = value;
	}
	...
	@JsonCreator
	public static ELayerStopReasonOperatorType fromValue(String value) {
		for (ELayerStopReasonOperatorType b : ELayerStopReasonOperatorType.values()) {
